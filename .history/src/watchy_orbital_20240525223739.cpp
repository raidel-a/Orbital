...
// vibrate motor every minute between the hours of 7 and 23
RTC_DATA_ATTR RTC_DATA_ATTR tmElements_t currentTime; // Add this line to declare the currentTime variable
