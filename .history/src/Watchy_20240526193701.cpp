...
void Watchy::showBuzz()
{
  ...
  while (1)
  {
    ...
    {
      settings.vibrateOClock++;
      if (settings.vibrateOClock > 5)
      {
        settings.vibrateOClock = 0;
      }
    }
    ...
    if (digitalRead(UP_BTN_PIN) == 1)
    {
      ...
      if (settings.vibrateOClock < 0)
      {
        settings.vibrateOClock = 5;
      }
    }

    // display.fillScreen(GxEPD_BLACK);
    display.setCursor(0, 60);
    display.println("Buzz every ");
    if (settings.vibrateOClock == 0)
    {
    ...
    {
      display.println("5 minutes");
    }
    else if (settings.vibrateOClock == 3)
    {
      display.println("15 minutes");
    }
    else if (settings.vibrateOClock == 4)
    {
      display.println("30 minutes");
    }
